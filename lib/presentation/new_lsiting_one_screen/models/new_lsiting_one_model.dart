...
/// This class defines the variables used in the [new_lsiting_one_screen],
/// and is typically used to hold data that is passed between different parts of the application.
class NewLsitingOneModel extends Equatable {
  NewLsitingOneModel({this.viewhierarchylistItemList = const []}) {}

  List<ViewhierarchylistItemModel> viewhierarchylistItemList;

  NewLsitingOneModel copyWith(
      {List<ViewhierarchylistItemModel>? viewhierarchylistItemList}) {
    return NewLsitingOneModel(
