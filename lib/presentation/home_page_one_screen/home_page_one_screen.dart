import 'bloc/home_page_one_bloc.dart';
...
class HomePageOneScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<HomePageOneBloc>(
        create: (context) => HomePageOneBloc(
            HomePageOneState(homePageOneModelObj: HomePageOneModel()))
              ...
              child: Padding(
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Padding(
                          padding:
                              EdgeInsets.only(left: 5.h, top: 4.v, bottom: 2.v),
                        ...
                        child: Column(
                            ...
                            children: [
                              _buildLaptopDellRow(context,
                                  laptopText: "lbl_duplex_home".tr,
                                  yearText: "lbl_1_200_00_yr".tr),
                              SizedBox(height: 10.v),
                              _buildTwentyRow1(context,
  ...
  Widget _buildLaptopDellRow(
    BuildContext context, {
    required String laptopText,
    required String yearText,
  }) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      Padding(
          padding: EdgeInsets.only(top: 2.v),
          child: Text(laptopText,
              textAlign: TextAlign.center,
  ...
  /// Navigates to the callToActionScreen when the action is triggered.
